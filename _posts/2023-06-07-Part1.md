...
function saveReadingPosition() {
  document.cookie = 'readingPosition=' + containerElement.scrollTop;
}
...
// Get the saved reading position from the cookie
var savedPosition = getCookieValue('readingPosition');
