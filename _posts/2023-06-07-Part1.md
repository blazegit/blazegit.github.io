...
[Link to a page]({% link assets/index.html %})


<div style="display: flex; flex-direction: column; height: 100vh;">
  <iframe src="/assets/index.html" style="flex: 1;"></iframe>
</div>


[Link to a page]({% link assets\sec+\part1\quiz.html %})

[Link to a page]({% link assets\sec+\part1\part1chapter1.json %})

<div style="display: flex; flex-direction: column; height: 100vh;">
  <iframe src="assets\sec+\part1\quiz.html?json=assets\sec+\part1\part1chapter1.json" style="flex: 1;"></iframe>
</div>
